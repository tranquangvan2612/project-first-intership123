...
import anh1 from "./assetsAnh/anh.png";
import anh2 from "./assetsAnh/photo-2.jpg";
      ...
      <div className="main-conatiner">
          ...
          <div className="menu-header">
            <div className="item-menu">
              ...
              <div className="menu-dropdown">
                <div className="menu-dropdown-element-one">
                  <div className="background-image-menu-dropdown">
                    <h3>Want to see an overview?</h3>
                    <p>See all the pages at once</p>
                    <a href="#">View all pages</a>
                  </div>
                </div>
                <div className="menu-dropdown-element-two">
                  <div class="menu-element-two-1">
            ...
            <div className="item-menu">
              <a>Pages</a>
              <div className="menu-dropdown menu-dropdown-two">
                <div className="menu-drop-page">
                ...
                <div className="menu-drop-page">
                  <h6 class="dropdown-header">PORTFOLIO (NEW)</h6>
                  <a>Masonry</a>
                  <a>Grid Rows</a>
                  <a>Parallax</a>
                  <a>Case Study</a>
            ...
            <div className="item-menu">
              <a>Account</a>
              <div className="menu-dropdown menu-dropdown-three">
                <div className="menu-dropdown-child">
                  <div className="item-account item-account-sign-in">
                    <a className="name-header-click">Sign In </a>
                    <FaChevronRight className="icon"></FaChevronRight>
                    <div className="menu-drop-child-account">
                      <a>Side Cover</a>
                      <a>Illustration</a>
                      <a>Basic</a>
                      <a>Modal Horizontal</a>
                      <a>Modal Vertical</a>
                    </div>
                  </div>

                  <div className="item-account item-account-sign-up">
                    <a className="name-header-click">Sign Up</a>
                    <FaChevronRight className="icon"></FaChevronRight>
                    <div className="menu-drop-child-account">
                      <a>Side Cover</a>
                      <a>Illustration</a>
                  ...
                  <div className="item-account">
                    <a className="name-header-click">Password Reset </a>
                    <FaChevronRight className="icon"></FaChevronRight>
                    <div className="menu-drop-child-account menu-drop-child-password">
                      <a>Side Cover</a>
                      <a>Illustration</a>
                      <a>Basic</a>
                    </div>
                  ...
                  <div className="item-account">
                    <a className="name-header-click">Error </a>
                    <FaChevronRight className="icon"></FaChevronRight>
                    <div className="menu-drop-child-account menu-drop-child-password">
                      <a>Side Cover</a>
                      <a>Illustration</a>
            ...
            <div className="item-menu">
              <a>Documentation</a>
              <div className="menu-dropdown menu-dropdown-documentation">
                <div className="border-bottom-fuc">
                  <div className="documentation-menu-item">
                    ...
                    <div className="content-documentation">
                      <a className="content-documentation-one">DOCUMENTATION</a>
                      <a className="content-documentation-two">
                ...
                <div className="border-bottom-fuc">
                  <div className="documentation-menu-item">
                    ...
                    <div className="content-documentation">
                      <a className="content-documentation-one">COMPONENTS</a>
                      <a className="content-documentation-two">
                ...
                <div className="border-bottom-fuc">
                  <div className="documentation-menu-item documentation-menu-item-bottom">
                    <div className="icon-documentation">
                      <svg
                        viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div className="content-documentation">
                      <a className="content-documentation-one">CHANGELOG</a>
                      <a className="content-documentation-two">
                        Keep track of changes
                      </a>
                    </div>
                    <p className="class-113">1.1.3</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <a href="#" className="button-buy-now">
            Buy now
          </a>
          <a href="#" className="icon-menu-bar">
            <FaBars></FaBars>
          </a>
        </div>
        ...
        <div className="section-content-two">
          <div className="section-content-item">
            <p className="content-hello">
              Welcome to <span>Landkit.</span>
              <br></br> Develop anything.
            </p>
            <p className="contenet-build-beau">
              Build a beautiful, modern website with flexible<br></br>
              Bootstrap components built from scratch.
            </p>
            <div>
              <a className="view-all-pages" href="#">
                View all pages
              </a>
          ...
          <div className="section-image-content">
            <img src={anh1} className="anh-section-one" />
          </div>
        </div>

        <div className="section-content-three">
          <div className="build-designed-documentation">
            ...
            <p className="bdd-class">Built for developers</p>
            <p className="content-long">
              Landkit is built to make your life easier.<br></br> Variables,
              build tooling, documentation,<br></br> and reusable components.
            </p>
          </div>
          <div className="build-designed-documentation">
            <div class=" text-primary mb-3">
            ...
            <p className="bdd-class"> Designed to be modern</p>
            <p className="content-long">
              Designed with the latest design trends in <br></br>mind. Landkit
              feels modern, minimal, <br></br>and beautiful.
            </p>
          </div>
          <div className="build-designed-documentation class-docu-every">
            <div class=" text-primary mb-3">
              <svg
                width="50"
                height="50"
            ...
            <p className="bdd-class">Documentation for everything</p>
            <p className="content-long">
              We've written extensive documentation <br></br>for components and
              tools, so you never <br></br>have to reverse engineer anything.
            </p>
          </div>
        </div>

        <div className="section-content-four">
          <div className="border-logo-big">
            <div className="logo-company-big">
              <svg
                width="170"
        ...
        <div className="container">
          <div className="image-main-form">
            <div className="image-on-form">
              <img src={anh2}></img>
            </div>
            <div className="form-under-form">
              {/* Form */}
              <form>
                <div className="form-label-group form-label-group-one">
                  <input
                    type="text"
                ...
                <div className="download-sample">
                  <button
                    className="button-download-sample"
                    type="submit"
                  >
                    Download a sample
                  </button>
          ...
          <div className="infor-content-main">
            <p className="infor-content-one">
              The most useful resource <br></br> ever created for
            </p>
            <p className="infor-content-two">
              Using Landkit to build your site means never<br></br> worrying about
              designing another page or cross<br></br>browser compatibility. Our
              ever-growing library of<br></br>components and pre-designed layouts will
              make <br></br>your life easier.
            </p>
            <div className="infor-content-three">
              <div className="container-d-flex">
              <div className="d-flex">
               <div className="check-icon"> <FaCheck></FaCheck></div>
